...
<div class="container">
    ...
    <div class="col-md-3">
			...
			<a href="{{url('/carrouselldos/create')}}" class="btn btn-success" >Agregar nueva imagen al carrousel</a>
...
<table class="table table-light">
	...
	<tbody>
		@foreach($carrouselldos as $carrousel)
		<tr>
			 ...
			 <td>
			 		<a href="{{url('/carrouselldos/'.$carrousel->id.'/edit')}}" class="btn btn-warning">Editar</a>
			  

			 	<form method="post" action="{{url('/carrouselldos/'.$carrousel->id)}}">
			 		{{csrf_field()}}
			 		{{method_field('DELETE')}}
