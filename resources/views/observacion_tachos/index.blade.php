...
function exportF(elem) {
  ...
  elem.setAttribute("download", "observacion_tachos.xls"); // Choose the file name
  return false;
}
</script>
...
<div class="container">
      <div class="row justify-content-left">
        <div class="col-md-3">
			...
			<a href="{{url('/observacion_tachos/create')}}" class="btn btn-success" >Agregar nuevo Parámetro</a>
        ...
        <div class="col-md-12">
		    ...
		    <div style="overflow-x:auto;">      
             ...
             <th>Acciones</th>	
			    ...
			    <tbody>
				 @foreach($ing_observacion_tacho as $producto)
				  <tr>
					 <td>{{$loop->iteration}}</td>
				   <td>{{$producto->observacion_parametro}}</td>
						
					<td>
					 	<div class="btn-group">
		            	<a href="{{url('/observacion_tachos/'.$producto->id.'/edit')}}" class="btn btn-warning"><i class="fa fa-pencil" ></i></a>
					  		

					 	 <form method="post" action="{{url('observacion_tachos/'.$producto->id)}}">
					 		{{csrf_field()}}
					 		{{method_field('DELETE')}}
