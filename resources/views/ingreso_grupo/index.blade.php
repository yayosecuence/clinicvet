...
function exportF(elem) {
  ...
  elem.setAttribute("download", "nombre_grupo_trabajo.xls"); // Choose the file name
  return false;
}
</script>
...
<div class="container">
      <div class="row justify-content-left">
        <div class="col-md-3">
			...
			<a href="{{url('/ingreso_grupo/create')}}" class="btn btn-success" >Agregar nuevo Grupo</a>
        ...
        <div class="col-md-12">
		    ...
		    <div style="overflow-x:auto;">      
             ...
             <th>Acciones</th>	
			    ...
			    <tbody>
				 @foreach($ing_grupo_trabajo as $producto)
				  <tr>
					 <td>{{$loop->iteration}}</td>
				   <td>{{$producto->nombre_grupo_trabajo}}</td>
						
					<td>
					 	<div class="btn-group">
		            	<a href="{{url('/ingreso_grupo/'.$producto->id.'/edit')}}" class="btn btn-warning"><i class="fa fa-pencil" ></i></a>
					  		

					 	 <form method="post" action="{{url('ingreso_grupo/'.$producto->id)}}">
					 		{{csrf_field()}}
					 		{{method_field('DELETE')}}
