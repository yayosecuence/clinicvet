...
<div class="container">
      ...
      <div class="col-md-3">
            <div class="card">
			      ...
			      <a href="{{url('/gramaje/create')}}" class="btn btn-success" >Agregar contenido</a>
...
<table class="table table-light table-striped table-bordered" id="example"  style="width:100%">
	<thead class="thead-light">
		...
		<tr>
			 ...
			 <td>
			 	<div class="btn-group">
            	<a href="{{url('/gramaje/'.$grama->id.'/edit')}}" class="btn btn-warning"><i class="fa fa-pencil" ></i></a>
			  		

			 	<form method="post" action="{{url('/gramaje/'.$grama->id)}}">
			 		{{csrf_field()}}
			 		{{method_field('DELETE')}}
